...
from ItachiRobot import (DEV_USERS, OWNER_ID, DRAGONS, SUPPORT_CHAT, DEMONS,
...
def addsudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DEMONS:
        rt += "RequeRequesC to promote a Akatsuki to Hokage."
        data['supports'].remove(user_id)
        DEMONS.remove(user_id)

    if user_id in WOLVES:
        rt += "Requested UC to promote a Shinobi to Hokage."
    ...
    update.effective_message.reply_text(
        rt + "\nSuccessfully set  level of {} to Hokage!".format(
...
def addsupport(
    ...
    if user_id in DRAGONS:
        rt += "Requested UC to demote this Hokage to Akatsuki"
        data['sudos'].remove(user_id)
        DRAGONS.remove(user_id)

    if user_id in DEMONS:
        message.reply_text("This user is already a Akatsuki.")
        return ""

    if user_id in WOLVES:
        rt += "Requested UC to promote this Shinobi to Akatsuki."
        data['whitelists'].remove(user_id)
        WOLVES.remove(user_id)
    ...
    update.effective_message.reply_text(
        rt + f"\n{user_member.first_name} was added as a Akatsuki Member!")
...
def addwhitelist(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DRAGONS:
        rt += "This member is a Hokage, Demoting to Shinobi. Give him a mission rn."
        data['sudos'].remove(user_id)
        DRAGONS.remove(user_id)

    if user_id in DEMONS:
        rt += "This user is already a akatsuki, Demoting to Shinobi."
        data['supports'].remove(user_id)
        DEMONS.remove(user_id)

    if user_id in WOLVES:
        message.reply_text("This user is already a Shinobi.")
        return ""
    ...
    update.effective_message.reply_text(
        rt +
        f"\nSuccessfully promoted {user_member.first_name} to a Shinobi!")
...
def addtiger(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DRAGONS:
        rt += "This member is a Hokage, Demoting to Anbu."
        data['sudos'].remove(user_id)
        DRAGONS.remove(user_id)

    if user_id in DEMONS:
        rt += "This user is already a Akatsuki, Demoting to Anbu."
        data['supports'].remove(user_id)
        DEMONS.remove(user_id)

    if user_id in WOLVES:
        rt += "This user is already a Shinobi, Demoting to Anbu."
        data['whitelists'].remove(user_id)
        WOLVES.remove(user_id)

    if user_id in TIGERS:
        message.reply_text("This user is already a Anbu.")
        return ""
    ...
    update.effective_message.reply_text(
        rt +
        f"\nSuccessfully promoted {user_member.first_name} to a Anbu Member!"
    )
...
def removesudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DRAGONS:
        message.reply_text("Requested UC to demote this user to Villagers. usually made for die.")
        DRAGONS.remove(user_id)
        data['sudos'].remove(user_id)
...
def removesupport(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DEMONS:
        ...
        message.reply_text("This user is not a Akatsuki Member!")
        return ""
...
def removewhitelist(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in WOLVES:
        ...
        message.reply_text("This user is not a Shinobi!")
        return ""
...
def devlist(update: Update, context: CallbackContext):
    ...
    reply = "<b>Uchiha Clan Members ⚡️:</b>\n"
